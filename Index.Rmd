...
[![](Images/Mumbai Historic Map.jpg)](https://ma-us-2021.github.io/spatialanalysis/Images/Mumbai Historic Map.jpg){target="_blank"}
...
The map below shows the number of transit stops that one can walk to within 10 minutes from any point in the map. It is apparent that the highest concentration of transit stops is in the North-East part of the city, with certain parts having access to more than 60 transit stops within a short walking distance. 


[![](Images/Transit stops within 10 minute walk.png)](https://ma-us-2021.github.io/spatialanalysis/Images/Transit stops within 10 minute walk.png){target="_blank"}
...
[![](Images/Accessibility Score (Raster).png)](https://ma-us-2021.github.io/spatialanalysis/Images/Accessibility Score (Raster).png){target="_blank"}
...
[![](Images/Accessibility Score (Polygons).png)](https://ma-us-2021.github.io/spatialanalysis/Images/Accessibility Score (Polygons).png){target="_blank"}
...
[![](Images/Shootings within Chicago Neighbourhoods.png)](https://ma-us-2021.github.io/spatialanalysis/Images/Shootings within Chicago Neighbourhoods.png){target="_blank"}
...
[![](Images/Police precincts in Chicago Neighbourhoods.png)](https://ma-us-2021.github.io/spatialanalysis/Images/Police precincts in Chicago Neighbourhoods.png){target="_blank"}
...
[![](Images/Hawaii Multiracial Population.png)](https://ma-us-2021.github.io/spatialanalysis/Link/Final_Interactive Map_Manasa Acharya){target="_blank"}
